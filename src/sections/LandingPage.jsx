          ...
          >
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <PrimaryBtn
                ...
                BackIcon={
                  <FaArrowRight className="text-[0.95rem] text-black/85 transition-transform duration-300 group-hover:translate-x-1" />
                }
                ClickFun={() => setShowContactModal(true)}
              />
              <SecondaryBtn
                Title={"View Projects"}
                FrontIcon={<FaFolderOpen className="text-[0.7rem]" />}
                BackIcon={
            ...
            <div className="rounded-[0.95rem] border border-[hsl(127_24%_38%_/_0.18)] bg-[hsl(200_23%_8%_/_0.68)] px-4 py-3 shadow-[inset_0_0_0_1px_hsl(127_30%_46%_/_0.04)]">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-start gap-4 lg:border-r-1 lg:border-[hsl(127_20%_38%_/_0.45)] lg:pr-4">
